...
void init_diff( void )
{
    ...
    uint32_t j = 0;
		...
		pid_init(&(reac_tunning.pid), g_TempOfMach + tempUpperCtrlPara.TempcCompensate, 0, 0, 0);	//温度，P，I，D /*g_TempOfMach+tempUpperCtrlPara.TempcCompensate*/
